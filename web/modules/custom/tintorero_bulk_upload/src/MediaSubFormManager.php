...
namespace Drupal\tintorero_bulk_upload;
 ...
 *
 * @package Drupal\tintorero_bulk_upload
 */
class MediaSubFormManager implements ContainerInjectionInterface, MediaSubFormManagerInterface
{
   ...
   * Media Type Manager.
   *
   * @var \Drupal\tintorero_bulk_upload\MediaTypeManager
   */
   ...
   *   Entity type manager.
   * @param \Drupal\media\MediaTypeManager $mediaTypeManager
   *   Media Type Manager.
  ...
  public static function create(ContainerInterface $container)
  {
    return new static(
      ...
      $container->get('tintorero_bulk_upload.media_type_manager'),
      $container->get('token'),
