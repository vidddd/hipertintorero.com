...
class MediaBulkConfigForm extends EntityForm implements ContainerInjectionInterface
{
  ...
  public function form(array $form, FormStateInterface $form_state)
  {
    ...
    /** @var \Drupal\tintorero_bulk_upload\Entity\MediaBulkConfigInterface $mediaBulkConfig */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\tintorero_bulk_upload\Entity\MediaBulkConfig::load',
      ],
  ...
  {
    $tintorero_bulk_config = $this->entity;
    $status = $tintorero_bulk_config->save();

    $save_message = $this->t('Saved the %label Media Bulk Config.', [
      '%label' => $tintorero_bulk_config->label(),
    ]);
    ...
    $form_state->setRedirectUrl($tintorero_bulk_config->toUrl('collection'));
  }
}
